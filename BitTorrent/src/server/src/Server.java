...
public class Server {
	...
	public void divideInputFile() {
		try {
			...
			File inputFile = new File(dir+"/src/server/"+fname);
			...
			String newdir = dir + "/src/server/chunks/";
	...
	public File[] readConfigFile() throws FileNotFoundException {
		String in = null;
		int count = 0;
		BufferedReader br = new BufferedReader(new FileReader(dir + "/src/server/configuration.txt"));
		
		String chunksLoc = dir + "/src/server/chunks/";
